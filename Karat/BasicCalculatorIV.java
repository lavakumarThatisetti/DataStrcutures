...
public class BasicCalculatorIV {
    ...
    class Term {
        ...
        public String toString() {
            ...
            for (String s:var) ans.append("*").append(s);
            return para+ ans.toString();
        }
        ...
        int compareTo(Term that) {
            ...
            for (int i=0;i<this.var.size();i++)
            {
                int comparison=this.var.get(i).compareTo(that.var.get(i));
    ...
    /**
     Representation of the expression in the form: C1 * Term1 + C2 * Term2 + C3 * Term3 + .....

     @sign is used as an optimization variable representing a chain of changing sign of ALL coefficients
     */
    class Expression {
    ...
    List<Term> combine(List<Term> a){ //combine the similar terms
        a.sort(Term::compareTo); //sort all terms to make similar terms together
        List<Term> c=new ArrayList<>();
        for (Term t:a) {
    ...
    public List<String> basicCalculatorIV(String expression, String[] evalvars, int[] evalints) {
        ...
        while (i<n) {
            ...
            if (Character.isLetter(ch)) {
                ...
                stack.add(new Expression(s.toString()));
                continue;
            }
            if (ch=='(') pri+=2;
            if (ch==')') pri-=2;
    ...
    public static void main(String[] args) {
        ...
        BasicCalculatorIV basicCalculatorIV = new BasicCalculatorIV();

        String expression = "e + 8 - a + 5";
        String[] evalvars ={"e"};
        int[] evalints = {1};
        System.out.println(basicCalculatorIV.basicCalculatorIV(expression, evalvars, evalints));
        expression = "e - 8 + temperature - pressure";
        evalvars = new String[]{"e", "temperature"};
        evalints = new int[]{1, 12};
        System.out.println(basicCalculatorIV.basicCalculatorIV(expression, evalvars, evalints));
